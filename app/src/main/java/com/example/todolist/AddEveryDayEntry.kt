...
import com.example.todolist.databinding.AddEverydayEntryBinding
...
@AndroidEntryPoint
class AddEveryDayEntry : AppCompatActivity() {

    private lateinit var binding: AddEverydayEntryBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = AddEverydayEntryBinding.inflate(layoutInflater)
        ...
        binding.saveDailyEntry.setOnClickListener {
            ...
            if (note.isNotEmpty() && selectedTimeMillis != null) {
                val listItem = ListItem(
                    content = note,
                    time = selectedTimeMillis
                )
                viewModel.insertEverydayItem(listItem)
